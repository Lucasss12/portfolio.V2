...
export default function navbar() {
  return (
    <div className='border-[5px] border-borderGrey bg-backgroundGrey text-white font-medium flex justify-between sm:py-5 py-3 sm:px-20 px-5 sm:text-2xl rounded-[38px]'>
