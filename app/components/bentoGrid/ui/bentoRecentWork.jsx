...
export default function bentoRecentWork() {
  return (
   <div className='mt-6 sm:w-1/2 sm:p-12 p-5 rounded-2xl border-[5px] bg-backgroundGrey border-borderGrey'>
      ...
      <div className='mt-6 space-y-4'>
         ...
         <div className='flex flex-col justify-center'>
            <div className='flex items-center justify-between'>
               <h4 className='text-primary text-xl font-medium'>Formateur</h4>
